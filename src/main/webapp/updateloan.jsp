    ...
    <div class="pro">
        <div class="pro1">
          <form action="update" method="post">
            <label id="lb">Update your request</label><br><br><br>
            ...
            <input type="text" id="tb1" name="appAmount" value="<%= appamount%>"><br><br>
            <label for="type" id="t1">Type</label><br>
            <input type="text" id="tb1" name="type" value="<%= type%>"><br><br>
            <label for="reason" id="t1">Reason</label><br>
            <input type="text" id="tb1" name="reason" value="<%= reason%>"><br><br>
