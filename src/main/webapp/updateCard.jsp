    ...
    <div class="pro">
        <div class="pro1">
          <form action ="upcard" method="post">
            <label id="t1">Card Type</label><br>
            ...
            <input type="text" name="cName" value="<%=cName%>" id="tb1"><br><br>
            ...
            <input type ="date" name ="eDate" value="<%=eDate%>" id="tb1"><br><br>
            <label for="cvv" id="t1"> CVV</label><br>
            <input type="text" name="cvv" value="<%=cvv%>" id="tb1"><br><br>
