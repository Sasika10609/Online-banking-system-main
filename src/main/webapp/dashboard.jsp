...
<html lang="en">
  <head>
    ...
    <title>All Requests | Olympus</title>
  </head>
          ...
          %>
            ...
            <table align="center" cellpadding="10" id="responsive-data-table"
              ...
              <tr>
                ...
                <c:url value="updateloan.jsp" var="loupdate">
                ...
                <c:url value="deleteloan.jsp" var="lodelete">
                <c:param name="tid" value="<%= idx%>"/>
                <c:param name="cid" value="<%= senderx%>"/>
                <c:param name="amount" value="<%= amountx%>"/>
                <c:param name="type" value="<%= typex%>"/>
                ...
                <td><a href="${loupdate}"><button id="btn2">Update</button></a></td>
                <td><a href="${lodelete}"><button id="btn2">Delete</button></a></td>
